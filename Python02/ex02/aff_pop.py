...
def compare_campus_graph(campus1: str, campus2: str):
    ...
    converted from formatted strings (e.g., "6.9M") into integers before plotting.
    ...
    Notes:
        ...
        - The x-axis displays years at regular intervals (default: every 40 years).
        - The y-axis is dynamically scaled based on the maximum population value.
    """
	...
	if len(years) != len(country1_population) or len(years) != len(country2_population):
